...
module rx_path_tb;
    ...
    task automatic scenario_single_flit;
        begin
            send_flit(512'h5A5A_0001, 128'h44, 64'h4, 1'b1, 8'h21, 8'h43);
    ...
    task automatic scenario_burst_flits;
        begin
            send_flit(512'h5A5A_0002, 128'h55, 64'h5, 1'b0, 8'h65, 8'h87);
            send_flit(512'h5A5A_0003, 128'h66, 64'h6, 1'b1, 8'hA9, 8'hCB);
            repeat (2) @(posedge cxs_clk);
