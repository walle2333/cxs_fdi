...
| FDI侧输入 | tx_ready | Input | 1 | 内部 | fdi_lclk | 下游准备就绪(Valid/Ready握手) |
...
| 时钟名称 | 频率 | 描述 | RTL实现要求 |
|----------|------|------|-------------|
| cxs_clk | 2.0 GHz | CXS侧协议时钟 | 写端口时钟 |
| fdi_lclk | 2.0 GHz | FDI侧链路时钟 | 读端口时钟 |
...
|----------|----------|------|----------|------|
| TX_PATH_CTRL | 0x00 | 32-bit | R/W | TX路径控制 |
| TX_PATH_STATUS | 0x04 | 32-bit | R | TX路径状态 |
| TX_PATH_FIFO_STAT | 0x08 | 32-bit | R | FIFO状态 |
| TX_PATH_ERR_STATUS | 0x14 | 32-bit | R/W1C | 错误状态 |
